...
<div class="container">
            ...
            <div class="freshdesignweb-top">
                ...
                <a href="lost.php" target=""><b>Lost</b></a>
                <span class="right">
                    <a href="logout.php">
      ...
      <div  class="form" >
     	...
     	<?php      	  
    		...
    		<form id="contactform" method="post" action="" enctype="multipart/form-data">  
    			...
    			<input id="name" name="txtProduct" placeholder="Found Thing" required tabindex="1" type="text" title="Found thing"> 
    			 
    			<p class="contact"><label for="email">Image</label></p> 
    			<input type="file" name="file" tabindex="2" required> 
                
                <p class="contact"><label for="username">Found From</label></p> 
    			<input id="username" name="txtFoundFrom" placeholder="Where did you Found?" required tabindex="3" type="text" title="Where did you Found?"> 
    			...
    			<input id="username" value="<?php echo $row['EmailID']; ?>" name="txtEmail" placeholder="Your Email Address" readonly required tabindex="5" type="text" title="Your Email Address"> 
                <?php
			   }
				?>
                <p class="contact"><label for="username">Person Name</label></p> 
    			<input id="username" name="txtPersonName" placeholder="The Person Who have Found" required tabindex="6" type="text" title="The Person Who have found?">  
           ...
           <?php
            ...
            <input class="buttom" name="submit" id="submit" tabindex="8" value="Add Found" type="submit"> 	 
   </form> 
...
<?php
	...
	if((isset($_POST['txtProduct'])) and isset($_POST['txtCategory']) and isset($_POST['txtFoundFrom']) and 
